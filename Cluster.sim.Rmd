...
source("scripts/append_new_infecteds.R", local = knitr::knit_global())
```
...
# I think this is necessary just for the initial population (the first time I make population_summary)
...
transmission_record <- transmission_record %>% mutate(time_of_infection=0, infection_source=0, transmission=0, removal=0)
...
# Add infection_source variable to population_summary
